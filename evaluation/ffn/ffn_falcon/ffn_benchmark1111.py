...
TENSOR_PARAMS = ['FF1', 'O2', 'WFF1a', 'WFF1b', 'WO', 'X', 'attn_O2', 'attn_O3', 'attn_O_norm']
BLOCK_PARAMS = ['block_k', 'block_n']

def forward(FF1, O2, WFF1a, WFF1b, WO, X, attn_O2, attn_O3, attn_O_norm, block_k=16, block_n=16):
    """
