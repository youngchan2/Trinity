...
#         print("\nTesting TensorRT...")
#         block = TRT_Llama_Ffn(M, N, P, WO=WO, WFF1a=WFF1a, WFF1b=WFF1b, WFF2=WFF2).to(device=device)
#         block.half()
#         with torch.no_grad():
#             for _ in range(10):
#                 out = block(O2, X)
...
#         simple_block = PyTorchTensorProgram(M, N, P, WO=WO, WFF1a=WFF1a, WFF1b=WFF1b, WFF2=WFF2).to(device=device)
#         with torch.no_grad():
#             for _ in range(10):
